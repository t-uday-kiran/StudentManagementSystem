		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-library"></span><span class="mtext">Request</span>
						</a>
						<ul class="submenu">
							<li><a href="requests.php">Requests</a></li>
							<li><a href="request_type.php">Add Request</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-library"></span><span class="mtext">Public Notice</span>
						</a>
						<ul class="submenu">
							<li><a href="add_notice.php">Add Notice</a></li>
							<li><a href="notice.php">Manage Notice</a></li>
						</ul>
					</li>
					...
					<li>
						<a href="https://www.sbit.ac.in/" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-paper-plane1"></span>
							<span class="mtext">SBIT </span>
						</a>
					</li>
				</ul>
			</div>
