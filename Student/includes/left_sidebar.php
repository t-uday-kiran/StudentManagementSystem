		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-apartment"></span><span class="mtext"> Request </span>
						</a>
						<ul class="submenu">
							<li><a href="apply_request.php">Apply Request</a></li>
					...
					<li class="dropdown">
						<a href="https://drivetube.netlify.app/" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">Placements</span>
						</a>
