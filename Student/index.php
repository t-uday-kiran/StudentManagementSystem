		...
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600">you are in an institution established to serve the wider
							Christian community in Ghana and Africa.</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between pb-10">
							<div class="h5 mb-0">Department Students</div>
							<div class="table-actions">
								<a title="VIEW" href="Student.php"><i class="icon-copy ion-disc"
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Department Staff</div>
							<div class="table-actions">
								<a title="VIEW" href="Student.php"><i class="icon-copy ion-disc"
										data-color="#17a2b8"></i></a>
							</div>
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Public Notice</div>
						...
						<div class="user-list">
							<ul>
								<?php
								$query = mysqli_query($conn, "select * from tblpublicnotice ORDER BY tblpublicnotice.id desc limit 4") or die(mysqli_error());
								while ($row = mysqli_fetch_array($query)) {
									$id = $row['id'];
									?>
								...
								if ($query->rowCount() > 0) {
									foreach ($results as $result) { ?>
										...
										<td>
											<div class="table-actions">
												<a title="VIEW"
													href="view_leave.php?edit=<?php echo htmlentities($result->id); ?>"
