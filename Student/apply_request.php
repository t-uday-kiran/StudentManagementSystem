...
<?php
	...
	elseif($leave_days >= 0)
	{
		...
		$sql="INSERT INTO tblrequests(RequestType,ToDate,FromDate,Description,Status,IsRead,empid,num_days,PostingDate) VALUES(:request_type,:fromdate,:todate,:description,:status,:isread,:empid,:num_days,:datePosting)";
