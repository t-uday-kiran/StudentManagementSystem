						...
						<div class="card-box height-100-p overflow-hidden">
							<div class="profile-tab height-100-p">
								<div class="tab height-100-p">
									...
									<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="" role="tab">Attendance</a>
										</li>
										<li class="nav-item">
													...
													<div class="profile-edit-list row">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<input name="fname" class="form-control" type="text" required="true" readonly autocomplete="off" value="<?php echo $row['FirstName']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Last Name</label>
																<input name="lastname" class="form-control" type="text" placeholder="" required="true" readonly autocomplete="off" value="<?php echo $row['LastName']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<input name="dob" class="form-control" type="text" placeholder="" required="true" readonly autocomplete="off" value="<?php echo $row['Dob']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Gender</label>
																<select name="gender" class="custom-select form-control" required="true" readonly autocomplete="off" disabled>
														...
														<div class="weight-500 col-md-6">
															...
															<div class="form-group">
																<label>Address</label>
																<input name="address" class="form-control" type="text" placeholder="" required="true" autocomplete="off" value="<?php echo $row['Address']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Department</label>
																<select name="department" class="custom-select form-control" required="true" readonly autocomplete="off" disabled>
																	<?php
