    ...
    <div class="main-container">
        <div class="pd-ltr-20">
            <div class="title pb-20">
                <h2 class="h3 mb-0">Classroom Breakdown</h2>
            </div>
            <div class="row pb-10">
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="widget-data">
                                <div class="weight-700 font-24 text-dark">
                                    <?php echo htmlentities($count_reg_Student); ?>
                                </div>
                                <div class="font-14 text-secondary weight-500">Department Strength</div>
                            </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
                    <div class="card-box height-100-p widget-style3">
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="widget-data">
                                <div class="weight-700 font-24 text-dark">
                                    <?php echo ($count_reg_hod); ?>
                                </div>
                                <div class="font-14 text-secondary weight-500">Your Leaves</div>
                            </div>
                            <div class="widget-icon">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
                    <div class="card-box height-100-p widget-style3">
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="widget-data">
                                <div class="weight-700 font-24 text-dark">
                                    <?php echo ($count_reg_admin); ?>
                                </div>
                                <div class="font-14 text-secondary weight-500">Remaining Leaves</div>
                            </div>
                            <div class="widget-icon">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item"
                                                    href="edit_Student.php?edit=<?php echo $row['emp_id']; ?>"><i
                                                        class="dw dw-edit2"></i> Edit</a>
                                                <a class="dropdown-item"
                                                    href="Student.php?delete=<?php echo $row['emp_id'] ?>"><i
